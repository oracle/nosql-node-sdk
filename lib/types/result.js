 ...
 * {@link NoSQLClient#forTableState} methods and may also be the result of
 * {@link NoSQLClient#forCompletion} method.  It encapsulates the state of
 * the table that is the target of the operation.
 * <p>
 ...
 * {@link NoSQLClient#forCompletion} or {@link NoSQLClient#forTableState} to
 * be notified when the table reaches desired state (which, depending on the
 ...
 * {@link NoSQLClient#forCompletion}, {@link NoSQLClient#forTableState} or
 ...
 * read units
 * @property {number} writeUnits Write throughtput consumed by this operation, in
 * write units
 */
 ...
 * {@link NoSQLClient#putIfVersion} methods
 * @property {FieldValue} generatedValue Value generated if the operation created a
 * new value for an identity column. Present only if the table has an identity
 * column and a value was generated for that column by this operation
 */
...
/**
 * QueryResult represents the result of {@link NoSQLClient#query} method.
