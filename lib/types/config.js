...
/**
  ...
  * <em>https://ndcs.uscom-east-1.oraclecloud.com</em> or
  ...
  * is the default port for CloudSim)
  ...
  * config file), which must be one of {@link Region} enumeration constant
  * names, e.g. <em>AP_MUMBAI_1</em>, <em>US_ASHBURN_1</em>, etc.  Note that
  * if both {@link Config}#region and {@link Config}#endpoint are present,
  * {@link Config}#endpoint will be used
  ...
  * state as used by {@link NoSQLClient#forTableState} or waiting for
  * completion of {@link NoSQLClient#tableDDL} operation, as used by
  ...
  * attempts when polling for table state as used by
  * {@link NoSQLClient#forTableState} or waiting for completion of
  * {@link NoSQLClient#tableDDL} operation, as used by
  * {@link NoSQLClient#forCompletion}, in milliseconds.  Can be overriden by
  * <em>opt.delay</em> for these methods
