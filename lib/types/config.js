...
/**
  ...
  * @property {string} [statsLatencyPercentileMode=EXACT] Internal storage
  * mode for latency percentile samples. Valid values are EXACT and BUCKETED.
  * EXACT stores each latency sample. BUCKETED uses fixed latency buckets to
  * keep memory bounded during large load checks.
  ...
  * @property {boolean} [statsEnableLog=false] Whether interval statistics
  * should be logged.
