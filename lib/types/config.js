...
/**
  ...
  * be added to the default <em>opt.timeout</em> for these operations.  If
  * this poll timeout is <em>Infinity</em> (no timeout) as is default and
  * <em>opt.complete</em> is true, the DDL operation likewise will have no
  * timeout
