...
class NoSQLClient extends NoSQLClientImpl {
     ...
     * @param {string} profile Statistics profile: NONE, REGULAR, MORE, or ALL
     * @returns {NoSQLClient} This instance
     */
    setStatsProfile(profile) {
        return super.setStatsProfile(profile);
    }

    /**
     * Returns the client request statistics collection profile.
     * @returns {string} Statistics profile
     */
    getStatsProfile() {
        return super.getStatsProfile();
    }

    /**
     * Returns the statistics control object for this client.
     * @returns {object} Statistics control object
     */
    getStatsControl() {
