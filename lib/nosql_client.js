...
class NoSQLClient extends NoSQLClientImpl {
     ...
     * @param {Durability} [opt.durability] On-premise only. Set the desired
     * durability for master/replica sync/acks. If this is not set, the
     * default server-side durability settings are used. See {@link Durability}
     ...
     * when using this API.
     * @example // Using <em>queryIterable</em>
     * try {
