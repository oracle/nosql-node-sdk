...
class HttpClient extends EventEmitter {
    ...
    constructor(config) {
        ...
        this._stats = new StatsControl({
            ...
            latencyPercentileMode: config.statsLatencyPercentileMode,
            rateLimitingEnabled
        });
    ...
    _observeStatsError(op, req, err) {
        ...
        this._observeStats('observeError', op.name,
    ...
    setStatsProfile(profile) {
        this._stats.setProfile(profile);
        return this;
    }

    getStatsProfile() {
        return this._stats.getProfile();
    }
    ...
    async execute(op, req) {
        ...
        if (this._shouldObserveStats()) {
             ...
             */
            this._observeStats('observe', op.name, false,
