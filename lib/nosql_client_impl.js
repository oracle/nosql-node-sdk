...
${this._config.serviceType} (requires Cloud Service)`, null, req);
    ...
    _observeQueryStats(req) {
        try {
            this._client.getStatsControl()._observeQuery(req);
        } catch(err) {
            this._client._statsError = err;
        }
    }
...
array in the output for listRoles operation', null, req);
    ...
    get _serverSerialVersion() {
        return this._client._serverSerialVersion;
    }

    getStatsControl() {
        return this._client.getStatsControl();
    }
