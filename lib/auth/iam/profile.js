...
${credsSource}: ${creds.passphrase}`, cfg);
            ...
            /* Make a copy and wipe it when calling close. */
            this._passphrase = Buffer.isBuffer(creds.passphrase) ?
                Buffer.from(creds.passphrase) : creds.passphrase;
        }
    }
...
${profile._ociConfigSrc}`, cfg);
    ...
    close() {
        clearData(this._passphrase);
        this._passphrase = null;
        clearData(this._privateKey);
