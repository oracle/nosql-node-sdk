...
//Checks if obj has any of the properties specified (direct or from prototype)
function hasAnyProperty(obj, ...props) {
    return props.find(prop => Array.isArray(prop) ?
        hasAnyProperty(obj, ...prop) : prop in obj) != null;
}
