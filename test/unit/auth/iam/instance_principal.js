...
function doTest() {
    ...
    testTokenCache(cfg0, ipCfg, prepConfig, authProfile, () => token);
    testTokenAutoRefresh(cfg0, ipCfg, prepConfig, authProfile, () => token);
    testPrecacheAuth(cfg0, ipCfg, prepConfig, authProfile, () => token);
